...
public class Solution {
    ...
    public static void main(String[] args) {
        new Solution(1, "2", new Date());
    }

    public void calculateAndSetValue3(long value) {
        logger.trace("calculateAndSetValue3. value > Integer.MAX_VALUE. {}", value > Integer.MAX_VALUE);
        value -= 133;
    ...
    public void printString() {
        if (value2 != null) {
            logger.trace("printString. value2 != null. {}", value2 != null);
    ...
    public void printDateAsLong() {
        if (value3 != null) {
            logger.trace("printString. value3 != null. {}", value3 != null);
