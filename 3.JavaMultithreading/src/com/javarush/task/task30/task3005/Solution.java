...
public class Solution {
    ...
    public static void checkAFlag(D d) {
        if ( d == null ||  d.cs == null || d.cs.size() < 1 || d.cs.get(0).bs == null || d.cs.get(0).bs.size() < 1
                || d.cs.get(0).bs.get(0).as == null || d.cs.get(0).bs.get(0).as.size() < 1 || d.cs.get(0).bs.get(0).as.get(0).flag != true ){
